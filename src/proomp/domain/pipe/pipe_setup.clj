...
(defn k->iters [k]
  ...
  (condp = k :fastest 10 :fast 20 :default 30 :quality 40 :high-quality 50 :else 40))
(defn k->noise [k]
...
(def i2i-pipes
  {:fastest       (->PipeSetup (k->iters :fastest) (k->scale :default) (k->noise :default))
   ...
   :fastest-calm  (->PipeSetup (k->iters :fastest) (k->scale :default) (k->noise :calm))
   ...
   :fastest-noisy (->PipeSetup (k->iters :fastest) (k->scale :default) (k->noise :noisy))
